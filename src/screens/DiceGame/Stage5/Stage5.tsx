...
const Stage5 = () => {
    ...
    const [ boxes, setBoxes ] = useState<initialValuesType[]>(StageFiveInitialValues);
    ...
    const resetGame = () => {
        ...
        StageFiveInitialValues.forEach(box => {
            box.value = 0
        });
        StageFiveInitialValues[0].value = 1;
        StageFiveInitialValues[StageFiveInitialValues.length-1].value = 2;
        setBoxes(StageFiveInitialValues);
        setTurn('Player2');
    }
